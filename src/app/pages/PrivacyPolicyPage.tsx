  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-black text-white py-20 text-center">
        ...
        <p className="text-sm tracking-wide opacity-80">Last Updated: July 24, 2026</p>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8 text-gray-700">
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed">
                Shopify securely manages customer authentication, account data, checkout, and payment processing. We also use standard safeguards for the storefront, but no method of transmission over the internet is 100% secure and we cannot guarantee absolute security.
              </p>
            </div>
